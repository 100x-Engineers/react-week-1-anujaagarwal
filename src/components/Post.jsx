...
import Retweet from "../assets/Group 26840.png";
import Heart from "../assets/heart.svg";
import Reach from "../assets/Frame 27042.png";
...
function Tweet({
  ...
  return (
    <div
      data-tweet-id={id}
      className="box-border flex h-min border-b border-neutral-700 px-2 py-2"
    >
      <div className="mr-1 h-12 min-w-fit">
        <img
          src={UserAvatar}
          alt="User Picture"
